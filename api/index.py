...
<body>
    ...
    function loadStore() {
      // FORCE PURGE legacy fake grade placeholders
      const rawGrades = localStorage.getItem('soroban_student_grades');
      if (rawGrades && rawGrades.includes('division 1')) {
        localStorage.removeItem('soroban_student_grades');
      }
